...
fn ensure_generator_state_argument<'a, 'tcx>(
    ...
    let gen_ty = tcx.mk_generator(def_id, substs, interior);
...
fn compute_layout<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
    ...
    // The arguments must be stored in the generator
    // FIXME: Allow these to be removed. This must match with generator constructors in shim.rs
    for i in 1..mir.arg_count {
        live_locals.add(&Local::new(2 + i));
    }
