...
impl<'a> LoweringContext<'a> {
    ...
    fn record_body(&mut self, value: hir::Expr, decl: Option<&FnDecl>, generator: bool)
                   -> hir::BodyId {
        let body = hir::Body {
    ...
    {
        let old_generator = self.generator;
        self.generator = false;
        let result = f(self);
        let generator = self.generator;
        self.generator = old_generator;
        self.record_body(result, decl, generator)
    }
            ...
            ExprKind::Closure(capture_clause, ref decl, ref body, fn_decl_span) => {
                self.with_new_scopes(|this| {
                    this.with_parent_def(e.id, |this| {
                        let body_id = this.lower_body(Some(decl), |this| this.lower_expr(body));
