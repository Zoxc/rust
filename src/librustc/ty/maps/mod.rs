...
mod keys;
pub use self::keys::{Key, DummyId, DummyDefId};
...
define_maps! { <'tcx>
    ...
    [] fn dummy_bench_query_dummy_def_id: DummyBenchQueryDummyDefId(DummyDefId) -> bool,
    [] fn dummy_bench_query_def_id: DummyBenchQueryDefId(DefId) -> bool,
