...
pub struct CheckItemTypesVisitor<'a, 'tcx: 'a> { tcx: TyCtxt<'a, 'tcx, 'tcx> }
...
pub fn check_item_types<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> CheckItemTypesVisitor<'a, 'tcx> {
    CheckItemTypesVisitor { tcx }
}
